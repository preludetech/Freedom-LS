...
NUMBER_OF_GOOD_ACTIVITIES_BEFORE_LEVEL_UP = 5
MAXIMUM_SKIPS_IN_GOOD_ACTIVITY_STREAK = 2
NUMBER_OF_BAD_ACTIVITIES_BEFORE_LEVEL_DOWN = 3
MAXIMUM_SKIPS_IN_BAD_ACTIVITY_STREAK = 6
