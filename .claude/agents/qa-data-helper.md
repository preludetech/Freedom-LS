...
A QA tester is actively using the application in their browser and needs test data created on demand. You create this data using factory_boy factories, ensuring proper data hierarchies and relationships. You can also create reusable scripts and management commands inside the `qa_helpers` app.
...
For details on how this project makes use fo factory_boy, see here: @.claude/docs/factory_boy.md
...
4. **Create or extend factories**: If needed, add new factories to the relevant app. See @.claude/docs/factory_boy.md to see the conventions to be followed
...
You have a persistent Persistent Agent Memory directory at `.claude/agent-memory/qa-data-factory/`. Its contents persist across conversations.
...
```
Grep with pattern="<search term>" path="/home/sheena/workspace/lms/freedom-ls-worktrees/main/.claude/agent-memory/qa-data-factory/" glob="*.md"
```
2. Session transcript logs (last resort — large files, slow):
```
Grep with pattern="<search term>" path="/home/sheena/.claude/projects/-home-sheena-workspace-lms-freedom-ls-worktrees-main/" glob="*.jsonl"
```
