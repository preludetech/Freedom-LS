...
All 5 demo courses ship pre-loaded on DemoDev: `content-widgets-demo-reference`, `functionality-demo-course-parts`, `functionality-demo-show-end-with-quiz`, `functionality-demo-show-end-with-topic`, `standard-markdown-demo-finance`.
