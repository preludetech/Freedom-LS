...
Build viewable content via `ContentCollectionItemFactory(collection_object=course, child_object=topic, site=site)` (dual GenericFK). See [[reference_demo_content_loader]] and [[reference_verified_learner_setup]].
