---
name: password-reset-learner-command
description: qa_create_password_reset_learner command + the shared demodev_s1@email.com QA fixture email
metadata:
  type: reference
---
...
[[course-player-learner-command]] (`qa_create_course_player_learner`), which additionally
...
DemoDev site is id=3, domain 127.0.0.1:8000. See [[verified-learner-setup]] for the
