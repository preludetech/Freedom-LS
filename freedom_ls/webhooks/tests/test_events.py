...
class TestSendTestPing:
    def test_creates_event_and_delivery(self, mock_site_context: object) -> None:
        ...
        assert event.payload == {"ping": True}
    ...
    def test_bypasses_registry_validation(self, mock_site_context: object) -> None:
        """webhook.test is not in the registry but should still work."""
        from freedom_ls.webhooks.events import send_test_ping
