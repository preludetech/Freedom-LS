    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'constraints': [models.UniqueConstraint(fields=('user', 'content_type', 'object_id', 'role'), name='unique_object_role_per_user')],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                'constraints': [models.UniqueConstraint(fields=('user', 'site', 'role'), name='unique_site_role_per_user')],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                'indexes': [models.Index(fields=['user', 'is_active'], name='freedom_ls__user_id_7432a4_idx')],
                'constraints': [models.UniqueConstraint(fields=('user', 'role'), name='unique_system_role_per_user')],
            },
        ),
    ]
