PERMISSIONS: dict[str, str] = {
    ...
    # "freedom_ls_form_engine.view_form": "Can view form",
    # "freedom_ls_form_engine.add_form": "Can add form",
    # "freedom_ls_form_engine.change_form": "Can change form",
    # "freedom_ls_form_engine.delete_form": "Can delete form",
    # "freedom_ls_form_engine.view_formcontent": "Can view form content",
    # "freedom_ls_form_engine.add_formcontent": "Can add form content",
    # "freedom_ls_form_engine.change_formcontent": "Can change form content",
    # "freedom_ls_form_engine.delete_formcontent": "Can delete form content",
    ...
    # "freedom_ls_form_engine.view_questionoption": "Can view question option",
    # "freedom_ls_form_engine.add_questionoption": "Can add question option",
    # "freedom_ls_form_engine.change_questionoption": "Can change question option",
    # "freedom_ls_form_engine.delete_questionoption": "Can delete question option",
    ...
    # --- learner_management app (label: freedom_ls_learner_management) ---
    ...
    # "freedom_ls_learner_management.view_cohortmembership": "Can view cohort membership",
    # "freedom_ls_learner_management.add_cohortmembership": "Can add cohort membership",
    # "freedom_ls_learner_management.change_cohortmembership": "Can change cohort membership",
    # "freedom_ls_learner_management.delete_cohortmembership": "Can delete cohort membership",
    # "freedom_ls_learner_management.view_learnercourseregistration": "Can view learner course registration",
    # "freedom_ls_learner_management.add_learnercourseregistration": "Can add learner course registration",
    # "freedom_ls_learner_management.change_learnercourseregistration": "Can change learner course registration",
    # "freedom_ls_learner_management.delete_learnercourseregistration": "Can delete learner course registration",
    # "freedom_ls_learner_management.view_cohortcourseregistration": "Can view cohort course registration",
    # "freedom_ls_learner_management.add_cohortcourseregistration": "Can add cohort course registration",
    # "freedom_ls_learner_management.change_cohortcourseregistration": "Can change cohort course registration",
    # "freedom_ls_learner_management.delete_cohortcourseregistration": "Can delete cohort course registration",
    # "freedom_ls_learner_management.view_cohortdeadline": "Can view cohort deadline",
    # "freedom_ls_learner_management.add_cohortdeadline": "Can add cohort deadline",
    # "freedom_ls_learner_management.change_cohortdeadline": "Can change cohort deadline",
    # "freedom_ls_learner_management.delete_cohortdeadline": "Can delete cohort deadline",
    # "freedom_ls_learner_management.view_learnerdeadline": "Can view learner deadline",
    # "freedom_ls_learner_management.add_learnerdeadline": "Can add learner deadline",
    # "freedom_ls_learner_management.change_learnerdeadline": "Can change learner deadline",
    # "freedom_ls_learner_management.delete_learnerdeadline": "Can delete learner deadline",
    # "freedom_ls_learner_management.view_usercohortdeadlineoverride": "Can view user cohort deadline override",
    # "freedom_ls_learner_management.add_usercohortdeadlineoverride": "Can add user cohort deadline override",
    # "freedom_ls_learner_management.change_usercohortdeadlineoverride": "Can change user cohort deadline override",
    # "freedom_ls_learner_management.delete_usercohortdeadlineoverride": "Can delete user cohort deadline override",
    ...
    # "freedom_ls_form_engine.change_formprogress": "Can change form progress",
    # "freedom_ls_form_engine.delete_formprogress": "Can delete form progress",
    # "freedom_ls_learner_progress.view_topicprogress": "Can view topic progress",
    # "freedom_ls_learner_progress.add_topicprogress": "Can add topic progress",
    # "freedom_ls_learner_progress.change_topicprogress": "Can change topic progress",
    # "freedom_ls_learner_progress.delete_topicprogress": "Can delete topic progress",
    # "freedom_ls_learner_progress.view_courseprogress": "Can view course progress",
    # "freedom_ls_learner_progress.add_courseprogress": "Can add course progress",
    # "freedom_ls_learner_progress.change_courseprogress": "Can change course progress",
    # "freedom_ls_learner_progress.delete_courseprogress": "Can delete course progress",
    # "freedom_ls_form_engine.view_questionanswer": "Can view question answer",
    ...
    #   "freedom_ls_learner_management.manage_enrolment": "Can enrol and remove users"
    #   "freedom_ls_learner_progress.view_all_grades": "Can view all learner grades"
    #   "freedom_ls_learner_progress.manage_grades": "Can create, edit, and finalise grades"
