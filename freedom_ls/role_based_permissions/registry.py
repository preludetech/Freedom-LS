PERMISSIONS: dict[str, str] = {
    ...
    # "freedom_ls_learner_management.view_usercourseregistration": "Can view user course registration",
    # "freedom_ls_learner_management.add_usercourseregistration": "Can add user course registration",
    # "freedom_ls_learner_management.change_usercourseregistration": "Can change user course registration",
    # "freedom_ls_learner_management.delete_usercourseregistration": "Can delete user course registration",
