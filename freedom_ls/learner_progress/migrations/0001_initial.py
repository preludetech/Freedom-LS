    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_accessed_object_id', models.UUIDField(blank=True, null=True)),
                ...
                ('last_accessed_content_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='contenttypes.contenttype')),
                ('site', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='sites.site')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_updated_time', models.DateTimeField(auto_now=True)),
                ('form_progress', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='answers', to='freedom_ls_learner_progress.formprogress')),
