...
class TestCheckVariantSupport:
    ...
    def test_lucide_warns_about_solid_variant(self) -> None:
        warnings = check_variant_support()
        assert any(w.id == "icons.W001" for w in warnings)
