...
def partial_express_interest(request: HttpRequest, course_slug: str) -> HttpResponse:
    ...
    Returns HTTP 422 if the course is not COMING_SOON (validation-error path).
    On success, get_or_create the interest row (idempotent) and return the
    CTA partial in the interested state.
    """
