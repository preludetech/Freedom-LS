...
def test_get_current_page_number_no_answers(mock_site_context):
    ...
    page1 = FormPageFactory(form=form, title="Page 1", order=0)
    page2 = FormPageFactory(form=form, title="Page 2", order=1)
...
def test_get_current_page_number_partially_answered(mock_site_context):
    ...
    page1 = FormPageFactory(form=form, title="Page 1", order=0)
    page2 = FormPageFactory(form=form, title="Page 2", order=1)
    page3 = FormPageFactory(form=form, title="Page 3", order=2)
...
def test_get_current_page_number_page_with_text_only(mock_site_context):
    ...
    FormContentFactory(form_page=page1, content="Intro text", order=0)
