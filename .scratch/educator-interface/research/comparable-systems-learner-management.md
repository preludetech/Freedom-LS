...
Research for `.scratch/educator-interface/issues/01-comparable-systems-learner-management.md`.
...
This extends two earlier notes in `spec_dd/1. next/educator-interface-full-polish/01. educator
interface critical functionality/`. `research_lms_educator_ux.md` covered cohort structure, adding
...
Following the question in the `learner-management-actions` idea:
