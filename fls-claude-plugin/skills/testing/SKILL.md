...
Refer to `${CLAUDE_PLUGIN_ROOT}/resources/testing.md` for full patterns and examples.
Refer to `${CLAUDE_PLUGIN_ROOT}/resources/factory_boy.md` for factory patterns and available factories.
