...
description: Subagent wrapper for `/plan_security_review` invoked by `/plan_dev`. Reads the corresponding command file in full and follows its subagent-mode instructions, emitting a structured findings report instead of editing the plan.
...
1. Read `fls-claude-plugin/commands/sdd/plan_security_review.md` in full.
