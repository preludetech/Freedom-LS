---
description: Initialise an SDD workflow by creating a todo.md checklist next to the spec or idea
allowed-tools: Read, Write, Glob, Bash
---

This command sets up a `todo.md` checklist that tracks a spec through the full Spec-Driven Development workflow.
...
- Read it.
- Ask the user whether to overwrite it or leave it alone.
...
- A one-line reminder that the user should tick remaining items as they go, and what the likely next action is
