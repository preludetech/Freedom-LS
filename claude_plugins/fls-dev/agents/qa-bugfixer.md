...
Consult the **`ds:testing`** skill before writing any test. It is the authority on:
...
by `fls-dev:qa-data-helper` during the same QA run — and those must NOT end up in your commit.
