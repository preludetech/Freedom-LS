...
allowed-tools: Read, Write, Edit, Glob, Bash, Agent, mcp__plugin_ds_playwright*
---
...
a `Bash` or Playwright call in the same turn. The `fls-dev:qa-bugfixer` spawn (Step 13) is a
