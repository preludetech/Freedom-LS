...
Delete this command's scratch file once the review is complete (recipe step 7):

```bash
.claude/fls-dev/scripts/delete_sdd_work_files.sh --prune-empty .sdd-work/plan_security_findings.md
```
