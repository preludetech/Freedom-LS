...
description: FreedomLS-specific extension of the ds:playwright-tests skill. Explains why the playwright marker exists for FLS downstream exclusion. Use alongside ds:playwright-tests when writing browser tests in the FreedomLS repo.
