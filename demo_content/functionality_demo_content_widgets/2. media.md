...
<c-picture src="images/diagram.svg" alt="A request flow diagram: a Browser box on the left and a Server box on the right, joined by two arrows" title="Figure 2: how a request flows from browser to server and back" number="2"></c-picture>
<dl>
