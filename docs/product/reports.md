...
**Cover** — the cohort, its organisation, the courses covered with inactive registrations marked, and when the report was generated and by whom. It states plainly that both the figures and the cohort's membership are a snapshot taken at generation time.
