...
Spec 3 of 12 in the educator interface rebuild. Read `../educator-interface-full-polish/spec-order.md` first. Depends on spec 1. Runs in parallel with 2, 4 and 5.
