...
- [x] (user + cmd) Fix QA bug: course detail page scrolls sideways at a 375px viewport when a course-outline row has a long locked-topic title (TDD — failing test first, then fix)
