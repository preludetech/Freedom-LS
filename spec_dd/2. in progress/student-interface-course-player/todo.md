...
- [ ] (QA) (user + cmd) Fix QA bug: browser Back button doesn't close the bottom sheet — it navigates away instead (shared sidePanel component, affects player + educator) (TDD — failing test first, then fix)
